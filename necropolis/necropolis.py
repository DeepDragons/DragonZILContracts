...
def calc_gens(gens):
  ...
  g8 = get_gen(gens, f27)
  g9 = get_gen(gens, f25)
  g10 = get_gen(gens, f23)
  g11 = get_gen(gens, f21)
  g12 = get_gen(gens, f19)
  g13 = get_gen(gens, f17)
  g14 = get_gen(gens, f15)
  g15 = get_gen(gens, f13)
  g16 = get_gen(gens, f11)
  g17 = get_gen(gens, f9)
  g18 = get_gen(gens, f7)
  g19 = get_gen(gens, f4)
  g20 = get_gen(gens, f2)
...
def calc_amoun(zlp_amount, dmz_total_supply, token_id):
  return zlp_amount // (dmz_total_supply / 3 + token_id)

def calc_rewards(supply, gen_lab, combat):
  return (supply + gen_lab + combat)
...
combat = calc_gens(113557207084082392001653552727254081999999999999999999999999999999999999999999)
supply = calc_amoun(ZLP_AMOUNT, DMZ_SUPPLY, TOKEN_ID)
rewards = calc_rewards(supply, gen_lab, combat)
